      ...
      {showNotification && (
        <div className="session-expired-pop">
          <div className="session-expired-pop__content">
            ...
            <button onClick={() => setShowNotification(false)} className="session-expired-pop__close">
              &times;
            </button>
          </div>
        </div>
  ...
  {formError && (
    <div className="form__error-message">
      ...
      <span>{formError}</span>
        ...
        <Link href="/sign_up" className="auth-redirect-link">
          Don't have an account? <span className="highlight-tekst">Sign up</span>
        </Link>
      </form>
    </div>
  );
